...
describe("<CourseList />", () => {
  ...
  it("The courseList renders without crashing", () => {
    const wrapper = shallow(<CourseList />);
    expect(wrapper.exists()).toEqual(true);
  });

  describe("the courseList with list of courses", () => {
    beforeEach(() => {
      listCourses = [
    ...
    it("course renders the 5 different rows", () => {
  ...
  describe("courseList renders without listCourses or empty listCourses", () => {
    beforeEach(() => {
      listCourses = [];
    });
    ...
    it("course renders the 3 rows with listCourses empty", () => {
      const wrapper = shallow(<CourseList listCourses={listCourses} />);
      expect(wrapper.exists());
      wrapper.update();
      const item = wrapper.find("CourseListRow");
