...
describe("function rendering components", () => {
  it("function renders Notifications component without crashing", () => {
    const wrapper = shallow(<Notifications />);
    expect(wrapper.exists()).toBe(true);
  });

  it("function renders an unordered list", () => {
  ...
  it("function renders the right html", () => {
    const listNotifications = [
      { id: 1, type: "default", value: "New course available" },
      { id: 2, type: "urgent", value: "New resume available" },
      { id: 3, type: "default", html: getLatestNotification() },
  ...
  it('component renders the text "Here is the list of notifications"', () => {
  ...
  it("function should call handleDisplayDrawer when menu item clicked", () => {
    const listNotifications = [
      { id: 1, type: "default", value: "New course available" },
      { id: 2, type: "urgent", value: "New resume available" },
      { id: 3, type: "default", html: getLatestNotification() },
  ...
  it("component should call handleHideDrawer when close button is clicked", () => {
    const listNotifications = [
      { id: 1, type: "default", value: "New course available" },
      { id: 2, type: "urgent", value: "New resume available" },
      { id: 3, type: "default", html: getLatestNotification() },
