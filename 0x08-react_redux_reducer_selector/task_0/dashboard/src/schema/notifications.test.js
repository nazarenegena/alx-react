...
describe("function tests for notifications in schema", () => {
  it("function should return the right data corresponding with given userId", () => {
    const expectedData = [
      {
  ...
  it("function should match results", () => {
    const results = [
  ...
  it("Component should have correct users entity", () => {
    const user = {
      age: 25,
  ...
  it("Component should have a correct messages entity", () => {
    const message = {
  ...
  it("Function should have a correct notifications entity", () => {
