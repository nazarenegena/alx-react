...
it("function renders the year 2021", () => {
  act(() => {
...
it("function checks getFooterCopy returns the correct string when true", () => {
  act(() => {
...
it("component checks getFooterCopy returns the correct string when false", () => {
  act(() => {
...
it("function checks getLatestNotification returns the correct string", () => {
  act(() => {
